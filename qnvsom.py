...
class QLearningAgent:
    def __init__(self, rata_inv=0.1, discount=0.9, rata_explorare=0.1, q_table_file="q_table.pkl"):
...
def main():
    ...
    while True:
        if stare_curenta.j_curent == InfoJoc.JMAX:
                            ...
                            if InfoJoc.celuleGrid[linie][coloana].collidepoint(pos):
                                ...
                                for l in range(InfoJoc.NR_LINII - 1, -1, -1):
                                    if stare_curenta.tabla_joc.matr[l][coloana] == InfoJoc.GOL:
                                        stare_curenta.tabla_joc.matr[l][coloana] = InfoJoc.JMAX
                                        break
